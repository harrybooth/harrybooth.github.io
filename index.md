...
standpoint. The original dissertation can be found [here](url), and code [here](). Stay tuned for the paper, which we are aiming to publish in the [Journal Of Artificial Life](https://direct.mit.edu/artl).  
